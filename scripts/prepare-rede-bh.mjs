...
const aliases = {
  operator_name: ["operator_name", "operadora", "operadora_nome", "operator"], product_name: ["product_name", "produto", "produto_nome", "plano", "nome_produto"],
  product_code: ["product_code", "codigo_produto", "codigo_plano"], city_name: ["city_name", "cidade", "municipio"], state_code: ["state_code", "uf", "sigla_uf", "estado"],
  provider_name: ["provider_name", "prestador", "nome_prestador", "estabelecimento"], provider_type: ["provider_type", "tipo_atendimento", "tipo_prestador", "tipo"],
  address: ["address", "endereco", "logradouro"], neighborhood: ["neighborhood", "bairro"], zip_code: ["zip_code", "cep"], phone: ["phone", "telefone"],
  email: ["email", "e_mail"], cnpj: ["cnpj"], cnes: ["cnes"], source_url: ["source_url", "url_fonte", "fonte_url"], last_updated: ["last_updated", "data_atualizacao", "atualizado_em"]
};
...
const columns = ["operator_name", "operator_key", "product_name", "product_key", "product_code", "city_name", "city_key", "state_code", "provider_name", "provider_key", "provider_type", "address", "neighborhood", "zip_code", "phone", "email", "cnpj", "cnes", "source", "source_url", "source_row_hash", "last_updated"];
